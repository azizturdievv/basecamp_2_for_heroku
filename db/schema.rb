...
ActiveRecord::Schema[7.0].define(version: 2022_12_15_045852) do
  ...
  create_table "todosets", force: :cascade do |t|
    t.string "name"
    t.integer "project_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["project_id"], name: "index_todosets_on_project_id"
  end
  ...
  create_table "vaults", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["project_id"], name: "index_vaults_on_project_id"
  end
  ...
  add_foreign_key "todosets", "projects"
  add_foreign_key "vaults", "projects"
end
